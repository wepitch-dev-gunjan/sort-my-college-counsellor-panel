  ...
  const [feedbacks, setFeedbacks] = useState([
    {
      ...
      rating: "5",
      comment:
        "Lorem Ipsum is simply dummy text of the printing and typesetting industry. lorem loremloremloremloremloremloremloremloremloremloremloremloremloremloremloremloremloremloremloremloremLorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged",
    },
    {
      image: "https://www.w3schools.com/howto/img_avatar2.png",
      name: "Sahil Aziz",
        ...
        {feedbacks.map((feedbacks, i) => (
          <div className="feedbacksBox">
            ...
            <div className="feebacksBoxDown">
              <div className="feedbacksComment">{feedbacks.comment}</div>
            </div>
          </div>
        ))}
      </div>
